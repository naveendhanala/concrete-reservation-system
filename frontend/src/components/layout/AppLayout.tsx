...
import {
  ...
  BarChart2, Users, Settings, LogOut, Bell, HardHat, Menu, X, Building2, Truck
} from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <header className="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button onClick={() => setSidebarOpen(true)} className="md:hidden p-1.5 text-gray-500 hover:text-gray-700 rounded-lg hover:bg-gray-100">
              <Menu className="w-5 h-5" />
            </button>
            <h1 className="text-sm font-medium text-gray-500 hidden sm:block">Concrete Reservation System</h1>
          </div>
          <div className="flex items-center gap-3">
            {/* Notifications bell */}
